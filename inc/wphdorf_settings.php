...
class WPHDeleteOldRemoteFiles {
    ...
    public function __construct() {
        add_action('admin_menu', array($this,
            'wp_h_delete_old_remote_files_add_plugin_page'));
        add_action('admin_init', array($this,
            'wp_h_delete_old_remote_files_page_init'));
    }
    ...
    public function wp_h_delete_old_remote_files_create_admin_page() {
        $this->wp_h_delete_old_remote_files_options = get_option(
            'wp_h_delete_old_remote_files_option_name');?>
...
<?php
        ...
        ?>
            ...
            <form method="post" action="options.php">
                <?php
settings_fields(
            'wp_h_delete_old_remote_files_option_group');
    ...
    public function wp_h_delete_old_remote_files_sanitize($input) {
        ...
        if (isset($input['server_0'])) {
            $sanitary_values['server_0'] = sanitize_text_field(
                $input['server_0']);
        }

        if (isset($input['benutzer_1'])) {
            $sanitary_values['benutzer_1'] = sanitize_text_field(
                $input['benutzer_1']);
        }

        if (isset($input['passwort_2'])) {
            $sanitary_values['passwort_2'] = sanitize_text_field(
                $input['passwort_2']);
        }

        if (isset($input['pfad_auf_dem_server_3'])) {
            $sanitary_values['pfad_auf_dem_server_3'] = sanitize_text_field(
                $input['pfad_auf_dem_server_3']);
        }

        if (isset($input['intervall_tage_4'])) {
            $sanitary_values['intervall_tage_4'] = sanitize_text_field(
                $input['intervall_tage_4']);
        }
    ...
    public function server_0_callback() {
        printf(
            ...
            isset($this->wp_h_delete_old_remote_files_options['server_0']) ?
            esc_attr($this->wp_h_delete_old_remote_files_options['server_0']) : ''
        );
    }
    ...
    public function benutzer_1_callback() {
        printf(
            ...
            isset($this->wp_h_delete_old_remote_files_options['benutzer_1'])
            ? esc_attr($this->wp_h_delete_old_remote_files_options['benutzer_1']) : ''
        );
    }
    ...
    public function passwort_2_callback() {
        printf(
            ...
            isset($this->wp_h_delete_old_remote_files_options['passwort_2'])
            ? esc_attr($this->wp_h_delete_old_remote_files_options['passwort_2']) : ''
        );
    }
    ...
    public function pfad_auf_dem_server_3_callback() {
        printf(
            ...
            isset($this
                    ->wp_h_delete_old_remote_files_options['pfad_auf_dem_server_3']) ? esc_attr($this
                    ->wp_h_delete_old_remote_files_options['pfad_auf_dem_server_3']) : ''
            );
        }
        ...
        public function intervall_tage_4_callback() {
            printf(
                ...
                isset($this
                    ->wp_h_delete_old_remote_files_options['intervall_tage_4']) ? esc_attr($this
                    ->wp_h_delete_old_remote_files_options['intervall_tage_4']) : ''
            );
        }
    }
    if (is_admin()) {
...
$wp_h_delete_old_remote_files_options = get_option(
    'wp_h_delete_old_remote_files_option_name'); // Array of All Options
...
$pfad_auf_dem_server_3 =
    $wp_h_delete_old_remote_files_options['pfad_auf_dem_server_3']; // Pfad Remote Server
